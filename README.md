...
<u>Создание и загрузка таблицы в clickhouse <b>default.topregion</b></u> 
...
<u>Создание и загрузка таблицы в clickhouse <b>default.minax_square_by_region_house</b></u> 
...
6. Выполните SQL скрипт в Python, который выведет топ 25 домов , у которых площадь больше 60 кв.м (airflow) (таблица в Clickhouse)
	...
	<u>Загруженные данные из файла за исключением выбросов загружены в таблицу в Clickhouse <b>default.buildings</b></u>
