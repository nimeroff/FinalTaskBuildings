...
<u>Количество записей: 590708</u>

2.Вычислите средний и медианный год постройки зданий
<u>Средний год постройки 1972</u>
<u>Медианный год постройки 1972</u>

3.Определите топ-10 областей и городов с наибольшим количеством объектов
<u>Топ 10 регионов-областей с наибольшим количеством объектов</u>
| region             | cnt_house|
|--------------------|----------|
|  Московская область|    24616 |
|              Москва|    21632 |
...
|  Ростовская область|     9942 |
|   Самарская область|     9792 |
<u>Создание и загрузка таблицы в clickhouse default.topregion</u> 
...
<u>Здания с максимальной и минимальной площадью в рамках каждой области</u>
...
<u>Создание и загрузка таблицы в clickhouse default.minax_square_by_region_house</u> 

5. Определите количество зданий по десятилетиям (например, сколько зданий построено в 1950-х, 1960-х и т.д.)
<u>Количество зданий по десятилетиям</u>
|mod_year|cnt_build|
|--------|---------|
|    1960|    95062|
|    1970|    84543|
...
|    1930|     9834|
|    1920|     3563|
<u>Создание и загрузка таблицы в clickhouse default.cnt_house_by_ten_years </u> 
![Количество зданий по десятилетиям](/dags/decade_cnt_house.png)

6. Выполните SQL скрипт в Python, который выведет топ 25 домов , у которых площадь больше 60 кв.м (airflow) (таблица в Clickhouse)<b/>
<u>Загруженные данные из файла за исключением выбросов загружены в таблицу в Clickhouse default.buildings</u>
<u>На основе таблицы default.buildings основан следующий результат</u>

<u>Топ 25 домов, у которых площадь больше 60</u>
